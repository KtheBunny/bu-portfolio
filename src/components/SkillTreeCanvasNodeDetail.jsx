...
export default function SkillTreeCanvasNodeDetail({
  open,
  x,
  y,
  icon,
  ...
  console.log("mastery in tooltip:", mastery);
  const { masterText, textColor, barColor } = getMasteryInfo(mastery);
  console.log("mastery info:", masterText, textColor, barColor);
  ...
  return (
    <FloatingPortal>
      ...
      >
        ...
        <p className="text-gray-400 mt-2 text-xs">EXP {mastery * 10} / 1000</p>
